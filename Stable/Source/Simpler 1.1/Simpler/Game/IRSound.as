package Simpler.Game
{
	...
	public class IRSound extends IRObject
	{
		...
		private static var s_sMuteAll:Boolean = false; // Static control for global volume
		private static var s_sKillAll:Boolean = false; // Static control for global sound
		
		public function IRSound(sound_:Sound,volume_:int = 100,loops_:int = 0):void
		{
			...
			else
			{
				...
				trace("[Simpler] IRSound (" + UID + ") could not be created, too many sounds!"); // MAX 30 Sounds!
			}
		} // Constructor
		...
		public static function get muteAll():Boolean
		{
			return s_sMuteAll;
		} // Get mute status
		public static function set muteAll(value_:Boolean):void
		{
			s_sMuteAll = value_;
		} // Mute all or not
