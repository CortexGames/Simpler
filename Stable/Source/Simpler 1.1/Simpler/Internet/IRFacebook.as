...
{
	// Facebook Classes \/ //
	import com.adobe.serialization.json.JSON; // Import the JSON Classes
	import com.facebook.graph.FacebookDesktop; // Import the Facebook Class
	// Simpler Classes \/ //
	import Simpler.Internet.IRFBObject; // Import the IRFBObject Class
	...
	public class IRFacebook
	{
		...
		public function IRFacebook(appid_:String = ""):void
		{
			...
			m_sAppID = appid_;
			FacebookDesktop.init(m_sAppID, onInit);
		} // Constructor
		...
		protected function AttemptLogin():void
		{
			if(!m_bLoggedIn)
			{
				...
				FacebookDesktop.login(onLogin,"read_stream"); //, opts);
			} // Prompt for Login
		...
		protected function SendPost(method_:String,parameters_:String):void
		{
			...
			FacebookDesktop.api(method_, onCallApi, params, "POST");
		} // POST to Facebook
		
		protected function SendGet(method_:String):void
		{
			FacebookDesktop.api(method_, onCallApi, null, "GET");
		} // GET to Facebook
