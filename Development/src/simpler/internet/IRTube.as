package simpler.internet
{
	...
	import flash.system.Security; // Import the IRGlobal Class
	...
	public class IRTube extends IRObject
	{
		...
		private function onPlayerReady(e:Event):void
		{
			...
			Global.FLASHSTAGE.addChild(m_cPlayer as DisplayObject);
			m_bLoaded = true;
		} // Config Video
		...
		{
			Global.FLASHSTAGE.removeChild(m_cPlayer as DisplayObject);
			m_cPlayer.destroy();
			m_cPlayer = null;
			m_lLoader = null;
			super.Destroy();
